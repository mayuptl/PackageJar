...
public class JsonReader {
     ...
     * during initialization using the {@code ConfigReader.getStrProp("JSON_TCID_KEY")}.
    ...
    private static final String TCID_KEY = ConfigReader.getStrProp("JSON_TCID_KEY");
    /**
     * Retrieves the input data for a specific test case ID from a JSON array file.
     * <p>The method searches the JSON array for a single object where the key defined by {@code TCID_KEY}
