...
public class TestRecorder extends ScreenRecorder {
    ...
    private final String DEFAULT_VIDEO_FOLDER = "./test-recordings/";
    public void startRecord(String recordedVideoName) throws Exception
    {
        startRecord(recordedVideoName,DEFAULT_VIDEO_FOLDER);
    }
    public void startRecord(String recordedVideoName,String userPath) throws IOException, AWTException {
        startRecordCoreLogic(recordedVideoName,userPath);
    }
    private void startRecordCoreLogic(String recordedVideoName,String userPath) throws IOException, AWTException {
...
// =============================================================================== //
    public String toGet_VideoFilePath(String testCaseName)
    {
    ...
    public String toGet_VideoFilePath(String testCaseName, String userPath) {
    ...
    private String toGet_VideoFilePath_CoreLogic(String testCaseName,String userPath)
    {
